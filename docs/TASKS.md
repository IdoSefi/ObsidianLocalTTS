...
| T-047 | Add backend-aware plugin settings and persisted active backend selection | DONE | agent | T-017 | Added `backend`, `kokoroVoice`, and `piperVoice` settings with Kokoro default and migration from legacy shared `voice` setting |
